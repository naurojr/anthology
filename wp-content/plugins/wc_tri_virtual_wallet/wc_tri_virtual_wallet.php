...
function my_custom_funtion(){
	...
	<div class="alert alert-danger" role="alert">
		You don't have credit availability or your credit balance is zero, please contact Anthology for more information.
	</div>
	<?php
	endif;
...
function iconic_information_endpoint_content() {
	...
	?>
		...
		<p>Your total credit limit is <strong><?php echo wc_price($total_credit_limit); ?></strong>. To increase credit availability you can <a href="<?php echo get_bloginfo('siteurl'); ?>/my-account/orders/">pay open invoices</a> or contact Anthology for additional credit. <p>
